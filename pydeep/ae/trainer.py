...
class GDTrainer(object):
    ...
    def __init__(self, model):
        ...
        '''
        The constructor takes the models as input

        :Parameters:
            models:    An auto-encoder object which should be trained.
                     -type: AutoEncoder
    ...
    def _train(self,
        ...
        if corruptor == None:
            ...
            #_,orginal_h = self.models._encode(data)
        ...
        # Get the gradients for the models
