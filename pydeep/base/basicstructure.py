    ...
    def __init__(self,
        ...
        if data is not None:
            ...
            if self.input_dim != data.shape[1]:
                raise ex.ValueError("Data dimension and models input dimension have to be equal!")
...
class StackOfBipartiteGraphs(object):
    ...
    def __setitem__(self, key, value):
        ...
        if value.input_dim == self._layers[key].input_dim and value.output_dim == self._layers[key].output_dim:
            ...
            raise Exception("New models have wrong dimensionality!")

    def append_layer(self, layer):
        """ Appends the models to the network.
