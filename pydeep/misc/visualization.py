...
def hidden_activation(rbm, data, states=False):
    ...
    :param rbm: RBM models object.
    :type rbm: RBM models object
...
def generate_samples(rbm,
                     ...
                     sample_states=False,
                     whitening=None):
    """ Generates samples from the given RBM models.

    :param rbm: RBM models.
    :type rbm: RBM models object.
    ...
    return tile_matrix_rows(result.T, v1, v2, iterations / stepsize + 1, data.shape[0], border_size=1, normalized=False), result 
