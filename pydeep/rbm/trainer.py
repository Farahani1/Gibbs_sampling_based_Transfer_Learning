...
class CD(object):
    ...
    def __init__(self, model, data=None):
        """ The constructor initializes the CD trainer with a given models and data.
...
class IPT(CD):
    ...
    def __init__(self,
                 ...
                 betas=3,
                 data=None):
        """ The constructor initializes the IPT trainer with a given models and
            data.
...
class GD(CD):
    ...
    def __init__(self,
                 model,
                 data=None):
        """ The constructor initializes the Gradient trainer with a given models.
